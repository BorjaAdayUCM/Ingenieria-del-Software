...
public class ModeloTablaRecepcionista extends ModeloTabla<Recepcionista> implements ObservadorSimulador {

	public ModeloTablaRecepcionista(String[] columnIdEventos, ControladorTrabajadores ctrl) {
	...
	public Object getValueAt(int indiceFil, int indiceCol) {
		...
		case 4:
			...
			break;
		case 5:
			s = this.lista.get(indiceFil).getIdiomas();
			break;
		case 6:
	...
	public <T> void actualiza(ArrayList<T> lista) {
		this.lista = (List<Recepcionista>) lista;
